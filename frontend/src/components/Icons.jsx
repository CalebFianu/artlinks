...
export const I = {
  ...
  substack: (p) => <Icon {...p}><path d="M4 4h16M4 8h16M4 12l8 5 8-5M4 16v4l8-5 8 5v-4" /></Icon>,
  reddit: (p) => <Icon {...p}><circle cx="12" cy="12" r="9" /><path d="M16.5 13.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM7.5 13.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fill="currentColor" /><path d="M15.5 16c-1 1-2.2 1.5-3.5 1.5s-2.5-.5-3.5-1.5M18.5 9.5a1.5 1.5 0 1 0-1 1.5M5.5 9.5a1.5 1.5 0 1 1 1 1.5M14.5 5l1-3 3 1" /></Icon>,
  discord: (p) => <Icon {...p}><path d="M9 12a1 1 0 1 0 0 2 1 1 0 0 0 0-2zM15 12a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" fill="currentColor" /><path d="M7.5 7.5S9 6 12 6s4.5 1.5 4.5 1.5M7.5 16.5S9 18 12 18s4.5-1.5 4.5-1.5M5 8c-.7 1.5-1 3.5-1 5 0 2.5 2 4 2 4l1.5-2M19 8c.7 1.5 1 3.5 1 5 0 2.5-2 4-2 4l-1.5-2" /></Icon>,
  whatsapp: (p) => <Icon {...p}><path d="M3 21l1.3-4.7A8.9 8.9 0 0 1 3 12a9 9 0 1 1 9 9 8.9 8.9 0 0 1-4.3-1.1L3 21z" /><path d="M9 10a2 2 0 0 0 0 4h.5l1 1.5a3.5 3.5 0 0 0 3-3l-.5-1.5A2 2 0 0 0 11 10H9z" /></Icon>,
};
