...
/* ========== LINE ICONS ========== */
// All icons: stroke-based, wobbly feel for the notebook variant via filter
...
/* ========== DOODLE DECORATIONS ========== */
// Playful hand-drawn SVG marginalia — only show in notebook variant (hidden via CSS)
const Doodles = {
...
Object.assign(window, { I, Doodles, cls, faviconFor, React, useState, useEffect, useMemo, useRef });
